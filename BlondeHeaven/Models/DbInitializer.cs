    ...
    public static class DbInitializer
    {
        public static void Seed(AppDbContext context)
        {
            ...
            if (!context.Feedbacks.Any())
            {
                context.AddRange
                (
                    new Feedback { Name = "张三", Email = "zhangsan@163.com", Message = "很好吃啊，下次还来", CreateDateUTC = DateTime.Now },
                    new Feedback { Name = "李四", Email = "lisi@163.com", Message = "第二次来了，大爱", CreateDateUTC = DateTime.Now },
                    new Feedback { Name = "王五", Email = "wangwu@163.com", Message = "好吃啊，我绝对不是托", CreateDateUTC = DateTime.Now }
                );
                context.SaveChanges();
            }
